function attachEvents(){
    ...
    function getWeather(){
        ...
        function displayCurrentConditions(data){
            ...
            $current
            .append(`<span class="condition symbol">${weatherString[condition]}</span>`);
        ...
        function displayThreeDayForecast(data){
            ...
            for (const day of values) {
                ...
                $parent.append(`<span class="symbol">${weatherString[day.condition]}</span>`);
                $parent.append(`<span class="forecast-data">${day.low}&#176;/${day.high}&#176;</span>`);
