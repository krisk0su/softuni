    ...
    class CountWorkingDays
    {
        ...
        static void Main(string[] args)
        {
            ...
            DateTime startDate = DateTime.ParseExact
                (firstDate, "dd-MM-yyyy", CultureInfo.InvariantCulture);
            DateTime endDate = DateTime.ParseExact
                (secondDate, "dd-MM-yyyy", CultureInfo.InvariantCulture);
                ...
                currentDate=currentDate.AddDays(1))
            {
                ...
                if ( !holidays.Contains(newDate) && currentDate.DayOfWeek != DayOfWeek.Saturday &&
